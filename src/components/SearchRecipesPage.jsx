...
const  SearchRecipes = () =>  { 
    ...
    const {data: recipes, isLoading , error} = useFetchRecipes(searchQuery) 
                 ...
                 <div className='p-6'>
                  ...
                  <div>
                   <input type="text" name="text" 
                    ...
                    className=' w-full px-16 py-3 border-2  border-orange-400 rounded-xl  focus:outline-none focus:ring-2 focus:ring-orange-500' 
                    placeholder='Enter recipe name...'/>
                  </div>  
                  <button
                       className="py-3 px-6 bg-orange-600 text-white rounded-3xl"
